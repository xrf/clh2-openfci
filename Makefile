...
uninstall: all
	rm -f $(DESTDIR)$(PREFIX)/include/clh2of.h $(DESTDIR)$(PREFIX)/bin/clhof-simple-dump.py $(DESTDIR)$(PREFIX)/bin/clh2of-pack $(DESTDIR)$(PREFIX)/bin/clh2of-simple-mod $(DESTDIR)$(PREFIX)/bin/clh2of-simple-tabulate $(DESTDIR)$(PREFIX)/bin/clh2of-tabulate $(DESTDIR)$(PREFIX)/bin/clh2of-unpack $(DESTDIR)$(PREFIX)/lib/libclh2of.so

.PHONY: all clean env install uninstall

dist/bin/clh2of-simple-mod: clh2of-simple-mod.o
	mkdir -p dist/bin
	$(CC) -o $@ clh2of-simple-mod.o
